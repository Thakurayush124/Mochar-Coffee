    ...
    <section className="w-full bg-[#e5e0d3] py-28">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-[1fr_1fr_1fr] gap-4 max-w-full">
          ...
          {/* -------- TOP 3 CARDS -------- */}
          <div className="bg-white p-4 rounded-xl shadow-sm w-96 h-50 max-w-full group">
            <Image
              src="choose1.svg"
              width={55}
              height={55}
          ...
          <div className="bg-white p-4 rounded-xl shadow-sm w-100 h-50 max-w-full group">
            <Image
              src="choose2.svg"
              width={55}
              height={55}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mt-10">
          ...
          <div className="bg-white p-12 rounded-xl shadow-sm group">
            <Image
              src="choose4.svg"
              width={55}
              height={55}
